...
/**
 * Couldn't achive 100%. For some reason, using HashMaps was too slow according to Codility
 *
 * Tasks Details
 * Easy
 * <p>
...
public class EquiLeader {
    /**
     * https://funnelgarden.com/equileader-codility-solution/ which scored 100% in everything
     *
     * @param A
     * @return
     */
    public int solutionFunnelGarden(int[] A) {
...
//
        Assert.assertEquals(2, el.solutionFunnelGarden(new int[]{4, 3, 4, 4, 4, 2}));
        Assert.assertEquals(0, el.solutionFunnelGarden(new int[]{1, 2, 3, 4, 5}));
        Assert.assertEquals(1, el.solutionFunnelGarden(new int[]{-1000000000, -1000000000}));
